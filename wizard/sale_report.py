...
class SaleReportAdvance(models.TransientModel):
    ...
    from_date = fields.Date(string="Start Date", default=fields.Date.today())
    to_date = fields.Date(string="End Date", default=fields.Date.today())
    ...
    def get_report(self):
        ...
        return self.env.ref('sale_siic.action_sale_report').report_action([], data=datas)
